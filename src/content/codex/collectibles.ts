...
export const COLLECTIBLES: readonly Collectible[] = [
  ...
  {
    id: 'yeongsanpo-gallery',
    name: CODEX_NAMES['yeongsanpo-gallery'],
    icon: '🏛️',
    category: '유적',
    location: '영산포 · 역사갤러리',
    description: '영산포 역사갤러리 안내판 문제를 풀고 확인했습니다.',
    isItem: false,
  },
  {
    id: 'yeongsanpo-literature',
    name: CODEX_NAMES['yeongsanpo-literature'],
    icon: '📖',
    category: '유적',
    location: '영산포 · 타오르는 강 문학관',
    description: '타오르는 강 문학관 안내판 문제를 풀고 확인했습니다.',
    isItem: false,
  },
  {
    id: 'item-hongeo-samhap',
    name: ITEM_NAMES['item-hongeo-samhap'],
    icon: '🍽️',
    category: '특산물',
    location: '영산포 · 홍어거리',
    description: '홍어거리에서 홍어삼합 만들기를 완성하고 받았습니다.',
    isItem: true,
  },
  {
    id: 'najueupseong-geumseonggwan',
    name: CODEX_NAMES['najueupseong-geumseonggwan'],
    icon: '🏯',
    category: '유적',
    location: '나주읍성 · 금성관',
    description: '금성관 앞에서 문제를 풀고 확인했습니다.',
    isItem: false,
  },
  {
    id: 'gate-namgomun',
    name: CODEX_NAMES['gate-namgomun'],
    icon: '🚪',
    category: '유적',
    location: '나주읍성 · 남고문',
    description: '남고문 수문장의 문제를 풀고 확인했습니다.',
    isItem: false,
  },
  {
    id: 'gate-dongjeommun',
    name: CODEX_NAMES['gate-dongjeommun'],
    icon: '🚪',
    category: '유적',
    location: '나주읍성 · 동점문',
    description: '동점문 수문장의 문제를 풀고 확인했습니다.',
    isItem: false,
  },
  {
    id: 'gate-seoseongmun',
    name: CODEX_NAMES['gate-seoseongmun'],
    icon: '🚪',
    category: '유적',
    location: '나주읍성 · 서성문',
    description: '서성문(영금문) 수문장의 문제를 풀고 확인했습니다.',
    isItem: false,
  },
  {
    id: 'gate-bukmangmun',
    name: CODEX_NAMES['gate-bukmangmun'],
    icon: '🚪',
    category: '유적',
    location: '나주읍성 · 북망문',
    description: '북망문 수문장의 문제를 풀고 확인했습니다.',
    isItem: false,
  },
  {
    id: 'item-guardian-token',
    name: ITEM_NAMES['item-guardian-token'],
    icon: '🎖️',
    category: '유물',
    location: '나주읍성 · 금성관',
    description: '나주읍성 4대문을 모두 지키고 나주목사님께 받았습니다.',
    isItem: true,
  },
  {
    id: 'item-naju-gomtang',
    name: ITEM_NAMES['item-naju-gomtang'],
    icon: '🍲',
    category: '특산물',
    location: '나주읍성 · 나주곰탕집',
    description: '곰탕집 할머니의 문제를 풀고 따끈한 나주곰탕 한 그릇을 받았습니다.',
    isItem: true,
  },
  {
    id: 'ddeuldeulgang-songbi',
    name: CODEX_NAMES['ddeuldeulgang-songbi'],
    icon: '🗿',
    category: '유적',
    location: '드들강 솔밭유원지 · 노래비',
    description: '드들강 솔밭유원지에서 안성현 선생 노래비를 둘러보며 확인했습니다.',
    isItem: false,
  },
  {
    id: 'item-ansunghyeon-songbook',
    name: ITEM_NAMES['item-ansunghyeon-songbook'],
    icon: '🎼',
    category: '유물',
    location: '드들강 솔밭유원지 · 강가',
    description: '리듬 악보를 완성하고 솔바람 요정 솔이에게 받았습니다.',
    isItem: true,
  },
  {
    id: 'jeongryeolsa-exhibit',
    name: CODEX_NAMES['jeongryeolsa-exhibit'],
    icon: '🏛️',
    category: '유적',
    location: '정렬사 · 유물전시관',
    description: '유물전시관에서 김천일 의병장의 유품과 의병 활동 기록을 살펴보았습니다.',
    isItem: false,
  },
  {
    id: 'jeongryeolsa-shrine',
    name: CODEX_NAMES['jeongryeolsa-shrine'],
    icon: '🪧',
    category: '유적',
    location: '정렬사 · 사당',
    description: '김천일 의병장과 아들 김상건, 양산숙, 임회, 이용재 등 충절 5위의 위패를 살펴보았습니다.',
    isItem: false,
  },
  {
    id: 'item-uibyeong-torch',
    name: ITEM_NAMES['item-uibyeong-torch'],
    icon: '🔥',
    category: '유물',
    location: '정렬사 · 모닥불',
    description: '의병 훈련을 마치고 김천일 의병장에게 받았습니다.',
    isItem: true,
  },
]
