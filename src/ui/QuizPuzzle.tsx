...
const QUIZZES: readonly Quiz[] = [
  ...
  {
    puzzleId: 'puzzle-najueupseong-gomtang',
    eyebrow: '곰탕집 퀴즈 · 나주곰탕집',
    icon: '🍲',
    question: '나주곰탕이 다른 곰탕과 다른 점은 무엇일까요?',
    options: ['뽀얗고 진한 사골 국물', '양지머리로 우려낸 맑고 깊은 국물', '매콤한 고춧가루 육수'],
    answer: 1,
    rewardItem: 'item-naju-gomtang',
    rewardLine: '나주곰탕은 사골을 진하게 우리는 대신 양지머리를 맑게 우려내는 것이 특징으로, 나주 5일장 장꾼과 길손을 배불리 먹이던 향토음식입니다.',
    wrongHint: '할머니가 아까 "국물이 이렇게 맑고 깨끗한" 이유를 말해 줬잖아. 무엇으로 우려낸다고 했지?',
    theme: 'amber',
  },
]
